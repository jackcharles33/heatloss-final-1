...
export const ageMultipliers: Record<PropertyAge, number> = {
  'PRE_1960': 1.2,          // Slight increase for older construction quality
  'BETWEEN_1960_2000': 1.15,  // Establish this as the baseline
  'BETWEEN_2000_2008': 1.1, // 5% improvement due to better standards
  'POST_2008': 1           // 10% improvement for modern, well-built homes
};
